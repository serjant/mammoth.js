...
var defaultStyleMap = require("./options-reader")._defaultStyleMap;
        ...
        .then(function(docxFile) {
            return docxReader.read(docxFile, input)
                .then(function(documentResult) {
                    documentResult.map(options.transformNumbering);
                    documentResult.map(options.transformSectionProperties);
