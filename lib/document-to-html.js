    ...
    function htmlPathForParagraph(element, messages) {
        ...
        if (style) {
            ...
            if (element.numbering && element.numbering.format) {
                for (var el of style_clone.to._elements) {
                    if((el.tagName == 'ul' || el.tagName == 'ol') && listTypes[element.numbering.format]) {
                       // el.attributes.type = listTypes[element.numbering.format];
                    }
                }
            }
