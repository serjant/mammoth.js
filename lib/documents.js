...
function Paragraph(children, properties) {
    ...
    return {
        ...
        fontSize: parseInt(properties.fontSize, 10) || 22,
        indent: {
            start: parseInt(indent.start || 0, 10),
            end: parseInt(indent.end || 0, 10),
            firstLine: parseInt(indent.firstLine || 0,  10),
            hanging: parseInt(indent.hanging || 0, 10)
        }
    };
}
