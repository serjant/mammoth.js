...
function BodyReader(options) {
    ...
    var xmlElementReaders = {
        ...
        "w:pPr": function(element) {
            return readParagraphStyle(element).map(function(style) {
                return {
                    ...
                    fontSize: element.firstOrEmpty("w:rPr").firstOrEmpty("w:sz").attributes["w:val"],
        ...
        "w:delText": function(element) {
            return elementResult(new documents.DelText(element.text()));
        },
        ...
        "w:commentRangeStart": function(element){
            ...
            return elementResult(new documents.CommentRangeStart({id: id}));
        },
        "w:commentRangeEnd": function(element){
            var id = element.attributes["w:id"];
            return elementResult(new documents.CommentRangeEnd({id: id}));
        },
        ...
        "w:ins": function(element) {
            return readXmlElements(element.children)
                .map(function(children) {
                    return new documents.Insert(children, element.attributes);
                });
        },
        "w:del": function(element) {
            return readXmlElements(element.children)
                .map(function(children) {
                    return new documents.Delete(children, element.attributes);
                });
        },
